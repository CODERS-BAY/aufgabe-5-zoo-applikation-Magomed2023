...
namespace ZooAPI.Controller
{
    ...
    public class ZoobesucherController : ControllerBase // Controller mit Basispfad
    {
        private readonly ZoobesucherService _service;

        // Service Injektion
        public ZoobesucherController(ZoobesucherService service) // Konstruktor
        {
            _service = service;
        }
        ...
        public async Task<ActionResult<List<Tier>>> GetAllTiere() // Action
        {
